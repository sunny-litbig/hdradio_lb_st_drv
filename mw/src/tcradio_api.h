...
typedef int32(*pfnOnCheckSeekQual_t)(eRADIO_MOD_MODE_t mod_mode, stRADIO_QUALITY_t qdata, uint32 freq, uint32 ntuner);		// mod_mode : 0 = FM, 1 = AM	// return value  0 = OK, -1 = NG
...
extern void tcradio_configOnCheckSeekQual(int32(*pfnCheckSeekQual)(eRADIO_MOD_MODE_t mod_mode, stRADIO_QUALITY_t qdata, uint32 freq, uint32 ntuner));
