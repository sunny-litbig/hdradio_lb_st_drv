...
****************************************************/
extern void tcradio_hal_ussleep(uint32 cnt);
extern void tcradio_hal_mssleep(uint32 cnt);
extern void tcradio_hal_16bto8b(uint8 *buf, uint16 data);
extern void tcradio_hal_32bto8b(uint8 *buf, uint32 data);
extern void *tcradio_hal_memset(void *pdst, uint8 ch, uint32 len);
extern void *tcradio_hal_memcpy(void *pdst, void *psrc, uint32 len);
